  ...
  const handleSend = async () => {
    ...
    try {
      const response = await ai.models.generateContent({
        ...
        contents: `You are a helpful Physics tutor helping a student study for their Physics II exam. Keep answers concise, accurate, and encouraging. Student asks: ${userMsg}`
      });
